import type { BillingReviewItem, Tax, PaymentMethod } from '../../../../api/billing-review/BillingReviewTypes';
...
export const normalizeDiscountType = (value: unknown): 'percentage' | 'fixed' | null => {
...
export const normalizeDraftBillingData = (billingData: any) => ({
