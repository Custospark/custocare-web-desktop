...
const pricingData = {
  essential: { monthly: '$39', annual: '$33' },
  professional: { monthly: '$149', annual: '$124' },
  enterprise: { monthly: '$399', annual: '$332' },
};

const tiers: TierProps[] = [
  {
    name: 'Essential',
    pricing: pricingData.essential,
  ...
  {
    name: 'Professional',
    pricing: pricingData.professional,
  ...
  {
    name: 'Enterprise',
    pricing: pricingData.enterprise,
    ...
    limits: [
      ...
      { label: 'Patients/mo', value: 'Unlimited' },
    ],
    cta: 'Contact Sales',
    ctaLink: '/signup',
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        >
          ...
          <p className={cn(
            ...
            One platform. Every department. No hidden fees. Start with a 14-day free trial — no credit card required.
          </p>
            ...
            >
              ...
              <div className="mb-6">
                <span className={cn(
                  ...
                  {annual ? tier.pricing.annual : tier.pricing.monthly}
                </span>
                <span className={cn(
              ...
              <div className={cn(
                ...
                theme === 'dark' ? "bg-slate-900/40 border-slate-700/60" : "bg-slate-50 border-slate-200"
              )}>
        ...
        <motion.div
          ...
          className={cn(
            "rounded-2xl border-2 p-6 sm:p-8 mb-16 overflow-x-auto",
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className={cn("border-b-2", theme === 'dark' ? "border-slate-700" : "border-slate-200")}>
                ...
                <th className="text-center py-3 px-2 font-semibold text-blue-600">Essential</th>
                <th className="text-center py-3 px-2 font-semibold text-blue-600">Professional</th>
                <th className="text-center py-3 px-2 font-semibold text-blue-600">Enterprise</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                ['Lab Tests, Prescriptions, Admissions', '✓', '✓', '✓'],
                ['Billing & Revenue', '✓', '✓', '✓'],
                ['Facility & Team Management', '✓', '✓', '✓'],
                ['Inventory & Supplies', '✓', '✓', '✓'],
                ['Patient Portal', '✓', '✓', '✓'],
                ...
                ['', '', '', ''],
                ['Staff Limit', '10', '50', 'Unlimited'],
                ['Departments', '3', '10', 'Unlimited'],
                ['Patients / Month', '500', '3,000', 'Unlimited'],
              ]).map((row, i) => (
                <tr key={i} className={cn(
                  "border-b",
                  theme === 'dark' ? "border-slate-800" : "border-slate-100",
                  row[0] === '' ? "" : (i % 2 === 0 ? (theme === 'dark' ? "bg-slate-800/20" : "bg-slate-50/50") : '')
                )}>
                  {row.map((cell, j) => (
                    <td key={j} className={cn(
                      "py-2.5 px-2",
                      j === 0 ? "font-medium text-left" : "text-center",
                      row[0] === '' && j === 0 && "text-xs font-bold uppercase tracking-wide text-slate-500",
                      cell === '✓' ? "text-emerald-500 font-bold" : cell === '—' ? "text-slate-400" : "",
                      theme === 'dark' ? "text-slate-300" : "text-slate-700"
                    )}>
                      {row[0] === '' && j === 0 ? 'Limits' : cell}
                    </td>
                  ))}
                </tr>
              ))}
