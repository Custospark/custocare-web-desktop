      ...
      <div className={cn('rounded-xl p-6 border', colors.border.primary, colors.bg.elevated)}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          <div className={cn('p-4 rounded-lg', colors.bg.secondary)}>
            ...
            <p className={cn('text-2xl font-bold', colors.text.primary)}>{spaces.length}</p>
          </div>
          <div className={cn('p-4 rounded-lg', colors.bg.secondary)}>
          ...
          <div className={cn('p-4 rounded-lg', colors.bg.secondary)}>
            <p className={cn('text-sm', colors.text.secondary)}>Inactive</p>
          ...
          <div className={cn('p-4 rounded-lg', colors.bg.secondary)}>
            ...
            <p className={cn('text-2xl font-bold', colors.text.primary)}>{filteredSpaces.length}</p>
          </div>
        </div>
      </div>
