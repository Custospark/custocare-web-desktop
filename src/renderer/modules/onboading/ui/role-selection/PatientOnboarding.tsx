 ...
 */
interface PatientSubmissionPayload {
  date_of_birth: string;
  biological_sex: BiologicalSex;
  emergency_contact: EmergencyContact;
}
...
export const PatientOnboarding: React.FC = () => {
   ...
   */
  const prepareSubmissionPayload = useCallback((): PatientSubmissionPayload => {
    return {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: PatientRegistrationResponse = await response.json();
      
      if (!data.success || !data.patient_id) {
        throw new Error('Invalid response from server');
      }

      // Success: Store patient ID and show completion screen
  ...
  }, [isFormComplete, prepareSubmissionPayload]);
      ...
      <footer className={cn(
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className={cn(
            ...
            © 2025 CustoCare AI. All information is encrypted and protected.
          </p>
        </div>
      </footer>
    </div>
