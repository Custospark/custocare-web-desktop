      ...
      >
        {hasData(billingActivity) ? (
          ...
          renderEmptyState(
            ...
            'Billing activity points will appear here when provided by the backend.'
          )
        )}
      </BillingRevenueDashboardSectionCard>
        ...
        >
          {hasData(performanceByDay) ? (
            ...
            renderEmptyState(
              ...
              'Performance-by-day items will appear here when returned by the backend.'
            )
          )}
        </BillingRevenueDashboardSectionCard>
        ...
        >
          {hasData(staffContribution) ? (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div className="min-w-0">
                        ...
                        <p className={cx('text-xs mt-1', ui.textMuted)}>
                          Staff ID {formatNumber(item.staff_id)}
                          {item.staff_uuid ? ` • ${item.staff_uuid}` : ''}
                        </p>
                      </div>
            ...
            renderEmptyState(
              ...
              'Staff contribution items will appear here when returned by the backend.'
            )
          )}
        </BillingRevenueDashboardSectionCard>
      </div>
