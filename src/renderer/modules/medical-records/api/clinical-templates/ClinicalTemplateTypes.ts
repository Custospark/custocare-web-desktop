...
export const templateToPrescriptionItem = (
  ...
  return {
    ...
    dosage_form: (med.dosage_form as DosageForm) || DosageForm.TABLET,
    dosage_quantity: med.dosage_quantity,
    dosage_unit: (med.dosage_unit as DosageUnit) || DosageUnit.TABLETS,
    frequency: med.frequency as Frequency,
    duration_value: med.duration_value,
    duration_unit: (med.duration_unit as DurationUnit) || DurationUnit.DAYS,
