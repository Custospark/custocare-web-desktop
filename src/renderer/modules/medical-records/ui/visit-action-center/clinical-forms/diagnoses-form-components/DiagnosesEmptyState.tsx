...
interface DiagnosesEmptyStateProps {
  isDark: boolean;
...
export const DiagnosesEmptyState: React.FC<DiagnosesEmptyStateProps> = ({
  isDark,
  colors,
    ...
    >
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className={cn('mt-2 text-sm leading-6', colors.text.secondary)}>
          Record the patient's diagnoses including primary, secondary, or differential 
          diagnoses using ICD-10/11 codes or free-text descriptions.
        </p>
...
export default DiagnosesEmptyState;