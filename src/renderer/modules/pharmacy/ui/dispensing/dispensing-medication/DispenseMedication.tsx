  ...
  const entryPoints: EntryPointConfig[] = [
    {
      ...
      to: PHARMACY_ROUTES.DISPENSING_WALK_IN,
    ...
    },
    {
      ...
      to: PHARMACY_ROUTES.DISPENSING_PATIENT_SEARCH,
    ...
    },
    {
      ...
      to: PHARMACY_ROUTES.DISPENSING_QUICK_CREATE,
    ...
    },
    {
      ...
      to: PHARMACY_ROUTES.DISPENSING_QUEUE,
