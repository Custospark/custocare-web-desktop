...
export const ConsultationsPreviewModal: React.FC<ConsultationsPreviewModalProps> = ({
  ...
  // Generate proper filename: patient_name_consultation_YYYY-MM-DD
  const documentTitle = useMemo(() => {
    // Get patient name from consultation
    ...
    // Get specialty for filename (fallback to 'consultation')
    ...
    // Build filename: patientName_specialty_YYYY-MM-DD
