...
import { AlertCircle, Calendar, CreditCard, FileText, Wallet } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        >
          {hasData(collectionsAging) ? (
            ...
            renderEmptyState(
              'No aging data',
              'Collections aging buckets will appear here when returned by the backend.'
            )
          )}
        </BillingRevenueDashboardSectionCard>
      </div>
        ...
        >
          {hasData(collectionsStatusDistribution) ? (
            ...
            renderEmptyState(
              ...
              'Billing status distribution will appear here when returned by the backend.'
            )
          )}
        </BillingRevenueDashboardSectionCard>
