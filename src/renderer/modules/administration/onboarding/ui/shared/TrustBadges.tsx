    ...
    >
      ...
      >
        <badge.icon 
          className={cn(
            "w-4 h-4",
            badge.color === 'emerald' && "text-emerald-800 dark:text-emerald-400",
            badge.color === 'blue' && "text-blue-800 dark:text-blue-400",
            badge.color === 'purple' && "text-purple-800 dark:text-purple-400"
          )}
          aria-hidden="true"
        />
        <span className={cn(
          "text-sm font-bold tracking-tight",
          badge.color === 'emerald' && "text-emerald-950 dark:text-emerald-500",
          badge.color === 'blue' && "text-blue-950 dark:text-blue-500",
          badge.color === 'purple' && "text-purple-950 dark:text-purple-500"
        )}>
          {badge.text}
        </span>
      </motion.div>
