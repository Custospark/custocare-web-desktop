...
import type { UserProfile, Gender } from '../../../api/settings/profile/ProfileTypes';
import { parsePhone } from '../../../api/settings/profile/ProfileTypes';
...
const buildUpdatePayload = (form: ProfileFormState, original: UserProfile): any => {
  ...
  if (g !== (original.gender ?? '')) payload.gender = (g || null) as Gender | null;
...
const UserProfile: React.FC<UserProfileProps> = ({ userId }) => {
  ...
  const handleField = useCallback((key: keyof ProfileFormState, value: string) => {
