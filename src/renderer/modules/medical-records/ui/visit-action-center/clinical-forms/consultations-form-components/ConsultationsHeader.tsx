...
export const ConsultationsHeader: React.FC<ConsultationsHeaderProps> = ({
  isDark,
  colors,
  hasActiveVisit,
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className={cn('mt-1 text-sm', colors.text.secondary)}>
              Request, manage, and track specialist consultations.
            </p>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              ...
              >
                ...
                {hasExistingConsultation ? 'Consultation recorded' : 'No consultation recorded yet'}
              </span>
