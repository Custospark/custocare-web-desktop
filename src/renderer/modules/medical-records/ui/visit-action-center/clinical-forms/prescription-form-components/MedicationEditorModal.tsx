...
interface MedicationEditorModalProps {
  ...
  isDark: boolean;
  colors: ColorTokens;
  editingMedication: PrescriptionItem | null;
  medicationForm: MedicationFormData;
  allergyAlertVisible: { medicationName: string; allergen: string; severity: string } | null;
  isMutating: boolean;
  onClose: () => void;
  onChange: (
...
export const MedicationEditorModal: React.FC<MedicationEditorModalProps> = ({
  open,
  isDark,
  colors,
  editingMedication,
                ...
                <div className={cn('mb-4 rounded-lg border p-3', isDark ? 'border-red-800/50 bg-red-900/20' : 'border-red-200 bg-red-50')}>
                  <div className="flex items-center gap-2">
                    ...
                    <p className={cn('text-sm', isDark ? 'text-red-300' : 'text-red-700')}>
                      Allergy alert: patient has {allergyAlertVisible.severity} allergy to "{allergyAlertVisible.allergen}"
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {medicationForm.as_needed && (
                    <div>
                      ...
                      <input
                        type="text"
                        required={medicationForm.as_needed}
...
export default MedicationEditorModal;
