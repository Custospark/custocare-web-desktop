          ...
          <div className="flex flex-col space-y-6">
            ...
            {financialLeakageSummary && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  <p className={cx('text-sm truncate', ui.textSecondary)}>Total Refund Amount</p>
                ...
                >
                  <p className={cx('text-sm truncate', ui.textSecondary)}>Total Voided Amount</p>
                  <p className={cx('text-base sm:text-lg font-bold mt-1 break-words', ui.text)}>
                ...
                >
                  <p className={cx('text-sm truncate', ui.textSecondary)}>Total Leakage Amount</p>
                ...
                >
                  <p className={cx('text-sm truncate', ui.textSecondary)}>Refund Transaction Count</p>
                  <p className={cx('text-base sm:text-lg font-bold mt-1 break-words', ui.text)}>
                ...
                >
                  <p className={cx('text-sm truncate', ui.textSecondary)}>Void Transaction Count</p>
                  <p className={cx('text-base sm:text-lg font-bold mt-1 break-words', ui.text)}>
                ...
                >
                  <p className={cx('text-sm truncate', ui.textSecondary)}>Average Refund Size</p>
                  <p className={cx('text-base sm:text-lg font-bold mt-1 break-words', ui.text)}>
                  ...
                  {financialLeakageReasons.map((item, index) => {
                    ...
                    return (
                      <div
                        key={item.reason}
                        className={cx(
                          'rounded-xl border p-3 sm:p-4 transition-all hover:shadow-md overflow-hidden',
                          isDark ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'
                        )}
                      >
                        <div className="flex flex-col space-y-3">
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <div className="text-right shrink-0">
                              <p className={cx('text-sm font-semibold whitespace-nowrap', ui.text)}>
              ...
              {inventoryLeakage.map((item) => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                    <div className="min-w-0 flex-1">
                      <p className={cx('text-base font-semibold truncate', ui.text)}>
                        {item.item_name}
                      </p>
                      <p className={cx('text-xs mt-1', ui.textMuted)}>
                        Code {item.item_code}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                    <div className={cx(
                      ...
                      <p className={cx('text-sm font-semibold mt-1', ui.text)}>
