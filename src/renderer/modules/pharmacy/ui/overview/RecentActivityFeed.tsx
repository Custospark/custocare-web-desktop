...
import type { PharmacyRecentActivityItem } from '../../api/overview/pharmacyDashboardTypes';

interface RecentActivityFeedProps {
  theme: 'light' | 'dark';
  refreshKey: number;
  items: PharmacyRecentActivityItem[] | undefined;
  isLoading: boolean;
}

function iconFor(type: PharmacyRecentActivityItem['type']) {
  switch (type) {
    case 'dispensed':
      return CheckCircle;
    case 'prescription':
...
function colorsFor(type: PharmacyRecentActivityItem['type'], isDark: boolean) {
  switch (type) {
    case 'dispensed':
      return {
